const listaloggedout = document.querySelectorAll('.logged-out');
 ...
 const obtienePlatillos = (data) =>{
        ...
        data.forEach(doc => {
            ...
            const columna = `
                <div class="col-12 col-md-4">
                    <img id='platillo' src="imagenes/${platillo.imagen}" alt="${platillo.nombre}">
                    <p>${platillo.nombre}</p>
    ...
    else{ listadeplatillos.innerHTML = '<p class="text-center">Ingrese con sus claves para ver los platillos.</p>'; }
 };